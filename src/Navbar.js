...
function Navbar({ cartCount, isLoggedIn, isAdminLoggedIn, handleSignOut }) {
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow">
      <div className="container-fluid">
        {/* Conditional rendering of the logo link */}
        {isLoggedIn ? (
              ...
              <>
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/Cart">
                    <img src="https://png.pngtree.com/png-vector/20190320/ourmid/pngtree-vector-shopping-cart-icon-png-image_850694.jpg" alt="Cart" width="20" className="d-inline-block align-text-top me-1" />
                    Cart ({cartCount})
                  </Link>
                </li>
                <li className="nav-item">
