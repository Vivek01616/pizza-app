...
function AdminDashboard() {
  ...
  useEffect(() => {
    fetchPizzas();
    fetchOrders(); // Added to fetch orders when component mounts
  }, []);
  ...
  const fetchPizzas = async () => {
    try {
      ...
      console.error(error);
      setNotification('Failed to fetch pizzas'); // Notify user of error
    }
  };
  ...
  const fetchOrders = async () => {
    try {
      ...
      console.error(error);
      setNotification('Failed to fetch orders'); // Notify user of error
    }
  };
